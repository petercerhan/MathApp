...
class FeedComposer {
    ...
    func composeGroupCompleteScene(groupCompleteItem: GroupCompleteTransitionItem) -> UIViewController {
        let vm = GroupCompleteViewModel(groupCompleteItem: groupCompleteItem)
